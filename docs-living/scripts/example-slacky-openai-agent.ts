...
import { SlackyOpenAiAgent } from '../../src/robots/SlackyOpenAiAgent';
...
async function testSlackyOpenAiAgent() {
  console.log('Testing SlackyOpenAiAgent...');
  ...
  console.log('\nSlackyOpenAiAgent test completed.');
}

testSlackyOpenAiAgent().catch(console.error);
