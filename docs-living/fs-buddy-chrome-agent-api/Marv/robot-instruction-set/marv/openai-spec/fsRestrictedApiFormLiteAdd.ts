...
const fsRestrictedApiFormLiteAdd = {
  ...
  parameters: {
    ...
    properties: {
      ...
      fields: {
        type: 'array',
        description: `An array of fields, each should have a title and type. The type should be one of the following: text, number, datetime, email, phone, address, signature, file, or section.
            Field descriptions may include optional properties such as hidden and required.
          `,
        items: { ...LiteFieldDescription },
      },
    },
